    ...
    <section class="lg:px-14 px-6 py-[60px]">
      <div class="grid grid-cols-1">
        <div class="col-span-1 lg:h-[500px] h-[300px] relative">
          ...
          <div
            class="absolute inset-0 bg-gradient-to-r from-black/70 via-black/40 to-transparent rounded-3xl"></div>
      ...
      <div class="grid rounded-3xl mt-10 grid-cols-3 bg-white py-[20px] lg:py-[30px]">
        <div
          class="col-span-1 py-[15px] lg:py-[35px] text-center border-r-[rgba(0,0,0,.1)] border-r">
