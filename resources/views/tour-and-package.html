...
<html lang="en">
  ...
  <body>
    ...
    <section
      id="offerSlider"
      class="lg:py-[100px] relative py-[60px] hidden lg:block px-6 lg:px-14"
    >
      <div class="text-center">
        ...
        <div class="swiper-wrapper">
          ...
          >
            <div class="inline-block w-[44%]">
              <h2
                class="text-[22px] block leading-[30px] font-semibold text-white"
              >
                We Make Every Trips Special
              </h2>
              <a
                href="#"
                class="bg-yellow-400 mt-2 inline-block text-[12px] text-black font-semibold px-5 py-2 rounded-full"
                >View More
      ...
      <div id="tourSwiper" class="swiper mySwiper mt-12">
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            <div
              class="col-span-1 relative border-[#E4E6E8] border rounded-3xl"
            >
              <div>
                <img
                  class="h-[270px] w-full object-cover rounded-t-3xl"
                  src="./images/img1.jpg"
                  alt
                />
              </div>
              ...
              <div
                class="bg-white px-6 py-7 lg:py-9 rounded-3xl -mt-10 relative z-[99]"
              >
                ...
                <div class="mt-2 flex gap-6">
                  <div class="flex gap-1 items-center">
                    ...
                    <span class="text-[#737373] lg:text-[12px] text-[11px]"
                      >2 days 3 nights</span
                    >
                  </div>
                  <div class="flex gap-1 items-center">
                ...
                <div class="mt-6 flex justify-between items-center">
                  ...
                  <a
                    href="#"
                    class="lg:text-[14px] text-[12px] border-[#E4E6E8] border px-6 py-1.5 rounded-full"
                    >Book Now</a
                  >
                </div>
                ...
                >
                  <i
                    class="fa-solid fa-star text-[#FFC700] text-[11px] lg:text-[12px]"
                  ></i>
                  <p class="lg:text-[12px] text-[11px] font-semibold">
                    4.96
                    <span class="text-[#737373] font-medium"
                      >(672 reviews)</span
                    >
                  </p>
                </div>
              ...
              <div class="absolute top-4 left-4">
                <span
                  class="lg:text-[11px] text-[10px] font-medium text-[#F09814] bg-white px-5 py-1.5 rounded-full"
                  >Top Rated</span
                >
              </div>
            </div>
    ...
    <section class="lg:px-14 px-6 p y-10">
      ...
      <div
        class="grid lg:grid-cols-4 grid-cols-2 auto-rows-[130px] lg:auto-rows-[250px] gap-3 lg:gap-6"
      >
        <div class="lg:col-span-3 col-span-2 row-span-2 relative">
          ...
          >
            ...
            <a
              class="bg-white text-black lg:h-[50px] lg:w-[50px] h-[40px] w-[40px] rounded-full flex justify-center items-center"
              href="#"
              ><i
                class="fa-solid fa-arrow-right lg:text-[16px] text-[14px] rotate-[240deg]"
              ></i
            ></a>
          </div>
        </div>
